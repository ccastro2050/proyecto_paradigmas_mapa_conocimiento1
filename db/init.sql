-- ============================================================
-- Base de datos del módulo MAPA DE CONOCIMIENTO — PostgreSQL
--
-- Este script SE DERIVA del que entrega el curso
-- (ProyectosDeAula/db_scripts/postgresql/mapa_conocimiento.pg.sql). No es una copia:
...
--   4. Las 18 tablas del módulo ganan 'activo BOOLEAN NOT NULL
...
DROP TABLE IF EXISTS docente_producto CASCADE;
DROP TABLE IF EXISTS aa_proyecto CASCADE;
DROP TABLE IF EXISTS ods_proyecto CASCADE;
DROP TABLE IF EXISTS proyecto_linea CASCADE;
DROP TABLE IF EXISTS ac_proyecto CASCADE;
DROP TABLE IF EXISTS palabras_clave CASCADE;
DROP TABLE IF EXISTS desarrolla CASCADE;
DROP TABLE IF EXISTS aliado_proyecto CASCADE;
