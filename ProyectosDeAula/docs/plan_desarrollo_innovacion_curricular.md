...
| | |
|---|---|
| **Proyecto** | Proyecto de aula — módulo de Innovación Curricular |
| **Documento** | Plan de Desarrollo de Software |
| **Versión del documento** | 1.0 |
| **Fecha** | 11 de septiembre de 2026 |
| **Alcance de la v1** | `area_conocimiento`, `universidad`, `aspecto_normativo`, `practica_estrategia`, `enfoque`, `car_innovacion`, `aliado` — **con su front** |
...
El sistema está descrito en [`modulo_innovacion_curricular.md`](modulo_innovacion_curricular.md), en
[`entrevista_innovacion_curricular.md`](entrevista_innovacion_curricular.md) y en
[`historias_usuario_innovacion_curricular.md`](historias_usuario_innovacion_curricular.md).
...
El módulo de Innovación Curricular sirve a Vicerrectoría Académica — dirección de currículo.
El problema que lo justifica es tres programas montando la misma innovación sin saberlo, y un mes por programa para armar el anexo de acreditación.
La versión 1 construye los **7 catálogos sin clave foránea** —`/api/area-conocimientos`, `/api/universidads`…— con su
API REST y su front.
...
|---|---|---|
| 1 | Registrar y consultar los 7 catálogos del módulo | Los 7 CRUD responden con sus códigos de estado correctos |
...
| Rol | Quién | Qué hace |
|---|---|---|
| **Cliente** | Vicerrectoría Académica — dirección de currículo | Aprueba las historias y los criterios de aceptación |
| **Interesados** | Dra. Patricia Uribe, Gloria Naranjo, Prof. Iván Betancur y Esteban Ruiz | Los de la entrevista: sus respuestas son el origen de las historias |
...
| 1 | Registrar los aspectos normativos con su fuente | Construcción | 8 | | |
| 2 | Separar enfoques de prácticas | Construcción | 12 | | |
| 3 | Registrar las características de innovación | Construcción | 5 | | |
| 4 | Retirar una estrategia abandonada | Construcción | 6 | | |
| 5 | Registrar los aliados por su NIT | Construcción | 7 | | |
| 6 | Mantener el catálogo de áreas de conocimiento | Construcción | 8 | | |
...
Son **30 puntos de historia** en 98 horas de equipo.

### d. Carga por persona

Las 98 horas son **de equipo**. Desde hoy hasta la última semana de
...
5. [`modulo_innovacion_curricular.md`](modulo_innovacion_curricular.md) — el modelo de datos y los
