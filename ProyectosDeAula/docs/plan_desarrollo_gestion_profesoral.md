...
## Módulo de Gestión Profesoral

---

| | |
|---|---|
| **Proyecto** | Proyecto de aula — módulo de Gestión Profesoral |
| **Documento** | Plan de Desarrollo de Software |
| **Versión del documento** | 1.0 |
| **Fecha** | 11 de septiembre de 2026 |
| **Alcance de la v1** | `area_conocimiento`, `termino_clave`, `linea_investigacion`, `programa`, `red` — **con su front** |
...
El sistema está descrito en [`modulo_gestion_profesoral.md`](modulo_gestion_profesoral.md), en
[`entrevista_gestion_profesoral.md`](entrevista_gestion_profesoral.md) y en
[`historias_usuario_gestion_profesoral.md`](historias_usuario_gestion_profesoral.md).
...
El módulo de Gestión Profesoral sirve a Vicerrectoría Académica — oficina de talento docente.
El problema que lo justifica es las dos semanas de correos que hoy cuesta responderle a la agencia acreditadora, y los 191 programas de los que nadie sabe quién dicta qué.
La versión 1 construye los **5 catálogos sin clave foránea** —`/api/area-conocimientos`, `/api/termino-claves`…— con su
API REST y su front.
...
|---|---|---|
| 1 | Registrar y consultar los 5 catálogos del módulo | Los 5 CRUD responden con sus códigos de estado correctos |
...
| Rol | Quién | Qué hace |
|---|---|---|
| **Cliente** | Vicerrectoría Académica — oficina de talento docente | Aprueba las historias y los criterios de aceptación |
| **Interesados** | Dra. Patricia Uribe, Mauricio Álvarez, Prof. Hernán Correa y Claudia Mesa | Los de la entrevista: sus respuestas son el origen de las historias |
...
| 1 | Registrar los programas académicos | Construcción | 12 | | |
| 2 | Corregir un programa | Construcción | 8 | | |
| 3 | Retirar un programa que se cerró | Construcción | 6 | | |
| 4 | Registrar las redes académicas | Construcción | 5 | | |
| 5 | Mantener el catálogo de áreas de conocimiento | Construcción | 8 | | |
| 6 | Registrar términos clave con su traducción | Construcción | 7 | | |
| 7 | Registrar y corregir líneas de investigación | Construcción | 7 | | |
...
Son **31 puntos de historia** en 100 horas de equipo.

### d. Carga por persona

Las 100 horas son **de equipo**. Desde hoy hasta la última semana de
...
5. [`modulo_gestion_profesoral.md`](modulo_gestion_profesoral.md) — el modelo de datos y los
