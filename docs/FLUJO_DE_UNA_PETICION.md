...
> Si está probando **SU reconstrucción** (la de la [GUIA_IA1](spec_kit/versiones/v1_proyecto/GUIA_IA1.md),
...
[postman/mapa_v1.postman_collection.json](../postman/mapa_v1.postman_collection.json).
